...
Analyzes accounts receivable aging, overdue balances, and customer-level collection risk using SQL, Python, and pandas.

### [Receivables Reconciliation & Action Engine](https://github.com/d0337b/receivables-reconciliation-action-engine)
Detects receivables reconciliation exceptions, assigns rule-based collection action priorities, and generates manager-level reporting outputs.
